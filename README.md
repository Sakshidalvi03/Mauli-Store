...
This project focuses on **data cleaning, transformation, KPI analysis, and dashboard visualization** using Microsoft Excel tools such as Pivot Tables, Pivot Charts, and Slicers.
...
The dashboard enables stakeholders to **monitor sales performance, identify growth opportunities, and support data-driven decision-making**.
...
## 🖼️ Dashboard Preview
![Mauli Store Sales Dashboard](MAULISTORE.png)
...
- Monthly sales trends reveal peak performance during seasonal periods  
